...
import AuctionRelayAbi from './abi/AuctionRelay.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.relay = new this.web3.eth.Contract(AuctionRelayAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.relay, contractAddresses.auctionrelay[networkId])
