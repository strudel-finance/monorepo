        ...
        <Table color="white" stickyHeader={true}>
          ...
          <TableBody>
            {lastRequest !== undefined && (
              <TableRow key="stub">
                <TableCell align="left">
                  <ReddishTextTypography className='reddish-typo' variant="caption">
                    {lastRequest.value} BTC <span className='reddish-icon'><FontAwesomeIcon icon={icons.chevronRight} /> </span> vBTC
                  </ReddishTextTypography>
                </TableCell>
                <TableCell>
                  {/* @TODO: Intergrate the colors there is green and orange ^^ */}
                  <ReddishTextTypography className='reddish-chip green' variant="caption">
