...
import { HarmonyVbtcToken } from './abi/types/HarmonyVbtcToken'
...
import { GovernanceToken } from './abi/types/GovernanceToken'
import { IUniswapV2Pair } from './abi/types/IUniswapV2Pair'
import { Contract } from 'web3-eth-contract'

export type VbtcContract = Contract & VbtcToken
export type HarmonyVbtcContract = Contract & HarmonyVbtcToken;
...
export type GStrudelContract = Contract & GovernanceToken
