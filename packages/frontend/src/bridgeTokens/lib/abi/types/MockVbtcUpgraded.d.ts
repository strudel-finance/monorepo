...
interface MockVbtcUpgradedInterface extends ethers.utils.Interface {
  functions: {
    ...
    "proofOpReturnAndMint(bytes,bytes,bytes4,bytes4,uint256,uint32,bytes,bytes)": FunctionFragment;
...
export class MockVbtcUpgraded extends Contract {
  ...
  interface: MockVbtcUpgradedInterface;
  ...
  functions: {
    ...
    "proofOpReturnAndMint(bytes,bytes,bytes4,bytes4,uint256,uint32,bytes,bytes)"(
      _header: BytesLike,
      _proof: BytesLike,
      _version: BytesLike,
      _locktime: BytesLike,
