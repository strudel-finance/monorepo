...
contract DutchSwapFactory is  OwnableUpgradeSafe, CloneFactory {
    ...
    function addCustomAuction(address _auction) onlyOwner public  {
    ...
    function deprecateFactory(address _newAddress) onlyOwner public  {
    ...
    function setDutchAuctionTemplate( address _dutchAuctionTemplate) onlyOwner public  {
